  ...
  return doc([
    ...
    section(
      [
        heroSlider([
          {
            // Brand artwork rather than stock: generated by scripts/site/heroArt.mts
            // and served from apps/web/public so it stays sharp at any width.
            image: "/hero-ribbon-wave.svg",
